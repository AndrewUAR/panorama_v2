...
const boxShadow = {
  boxShadow: `0 10px 30px -12px rgba(${hexToRgb(
    ...
    blackColor
  )}, 0.42), 0 8px 10px -5px rgba(${hexToRgb(blackColor)}, 0.4)`
};

const dropzoneBoxShadow = {
  boxShadow: `inset 0 10px 25px -6px rgba(${hexToRgb(
    blackColor
  )}, 0.7), inset 0 10px 25px 0px rgba(${hexToRgb(
    blackColor
  )}, 0.3), inset 0 8px 10px -4px rgba(${hexToRgb(blackColor)}, 0.7)`
};
