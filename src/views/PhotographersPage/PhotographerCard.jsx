      ...
      <Card color="blue">
        <CardHeader overflow="overflowBottom">
          <Rating
            ...
            readOnly
          />
          {favorite ? <FavoriteIcon className={classes.favoriteFilledIcon} onClick={() => setFavorite(false)}/> : <FavoriteBorderIcon className={classes.favoriteIcon} onClick={() => setFavorite(true)}/>}
        </CardHeader>
        <MediaCard
          component="img"
          alt="Photographer"
