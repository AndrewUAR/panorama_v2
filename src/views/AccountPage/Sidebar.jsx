    ...
    <div className={classes.photoArea}>
      <div className={classes.box}>
        <div style={{height: '100%', width: "100%"}}>
          ...
          <h3 className={classes.userName} onClick={() => handleSummary()}>{user.firstName} {user.lastName}</h3>
        </div>
        <div className={classes.buttonGroup}>
          <Button fullWidth color="transparent" sideBarButton><MessageIcon />My Messages</Button>
          <Button fullWidth color="transparent" sideBarButton onClick={() => handleAlbums()}><BurstModeIcon />My Albums</Button>
          <Button fullWidth color="transparent" sideBarButton><EventIcon />My Bookings</Button>
