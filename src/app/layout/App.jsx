...
const SettingsPage = lazy(() => import("../../views/SettingsPage/SettingsPage"));
const CreatePhotographerProfilePage = lazy(() => import("../../views/CreatePhotographerProfilePage/CreatePhotographerProfilePage"));
        ...
        <Container maxWidth="xl" disableGutters>
          <Suspense fallback={<LoadingComponent />}>
            <Switch>
              ...
              <RestrictedRoute 
                exact path="/my-profile/albums" 
                roles={["photographer", "admin"]} 
                component={() => 
                  <AccountPage component={<MyAlbums />} 
                />} 
              />
              <RestrictedRoute 
